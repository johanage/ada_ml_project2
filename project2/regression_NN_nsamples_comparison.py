...
nn = Neural_Network(X_train,  Y_train, costfunc = 'ridge', eta=eta,method = 'sgd',w_mom = True, symbolic_differentiation = True)
nn.add_layer(nodes = n_hidden_neurons, af = 'sigmoid')
nn.output_layer(af = 'linear')
# do SGD
# epochs, mini batches
nn.SGD(epochs, batch_size, printout = True, plot = True, **{'lambda' : lmbda})

# plot the prediction and the true data
